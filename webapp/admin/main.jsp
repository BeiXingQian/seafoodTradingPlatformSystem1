...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="${pageContext.request.contextPath}/admin/main.jsp" class="logo">
            <span class="logo-lg"><b>水产品商务系统</b></span>
        </a>
        <!-- 头部导航 -->
            ...
            <ul class="sidebar-menu">
                ...
                <li >
                    <a href="${pageContext.request.contextPath}/product/search" target="iframe">
                        <i class="fa fa-circle-o"></i>商品菜单
                    </a>
                </li>
                <li >
                    <a href="${pageContext.request.contextPath}/record/selectAllRecords" target="iframe">
                        <i class="fa fa-circle-o"></i>下单记录
                    </a>
                </li>
            </ul>
        </section>
    ...
    <div class="content-wrapper">
        <iframe width="100%" id="iframe" name="iframe" onload="SetIFrameHeight()"
                frameborder="0" src="${pageContext.request.contextPath}/product/selectNewProducts"></iframe>
    </div>
</div>
</body>
</html>